...
A Helm chart for StackAI Frontend Web Application
...
| image.repository | string | `"stackai.azurecr.io/stackai/stackweb"` |  |
| image.tag | string | `"v1.0.1"` |  |
| imagePullSecrets | list | `[]` |  |
| ingress.annotations | object | `{}` |  |
| ingress.className | string | `""` |  |
| ingress.enabled | bool | `false` |  |
| ingress.hosts[0].host | string | `"stackweb.local"` |  |
